...
class TestLoaderSave:
    ...
    async def test_save_reflects_loader(self, tool_idx):
    ...
    async def test_stale_tools_removed_after_save(self, tool_idx):
        loader.load(FIXTURES / "tools_ungrouped.yaml")
        await loader.save()
        loader.clear()
...
class TestLoaderSearch:
    ...
    async def test_returns_tool_models(self, tool_idx):
        loader.load(FIXTURES / "tools_ungrouped.yaml")
        await loader.save()
